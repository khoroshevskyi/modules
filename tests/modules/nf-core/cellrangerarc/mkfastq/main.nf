...
workflow test_cellrangerarc_mkfastq_simple_atac {
    ...
    simple_csv_atac = file(
        "https://cf.10xgenomics.com/supp/cell-arc/cellranger-arc-tiny-bcl-atac-simple-1.0.0.csv",
        checkIfExists: true
    )
    tiny_bcl_atac = [
        [],
        file(
            "https://cf.10xgenomics.com/supp/cell-arc/cellranger-arc-tiny-bcl-atac-1.0.0.tar.gz",
            checkIfExists: true
        ),
    ]
...
workflow test_cellrangerarc_mkfastq_simple_gex {
    ...
    simple_csv_gex = file(
        "https://cf.10xgenomics.com/supp/cell-arc/cellranger-arc-tiny-bcl-gex-simple-1.0.0.csv",
        checkIfExists: true
    )
    tiny_bcl_gex = [
        [],
        file(
            "https://cf.10xgenomics.com/supp/cell-arc/cellranger-arc-tiny-bcl-gex-1.0.0.tar.gz",
            checkIfExists: true
        ),
    ]
...
workflow test_cellrangerarc_mkfastq_illumina_atac {
    ...
    samplesheet_csv_atac = file(
        "https://cf.10xgenomics.com/supp/cell-arc/cellranger-arc-tiny-bcl-atac-samplesheet-1.0.0.csv",
        checkIfExists: true
    )
    tiny_bcl_atac = [
        [],
...
workflow test_cellrangerarc_mkfastq_illumina_gex {
    ...
    samplesheet_csv_gex = file(
        "https://cf.10xgenomics.com/supp/cell-arc/cellranger-arc-tiny-bcl-gex-samplesheet-1.0.0.csv",
        checkIfExists: true
    )
    tiny_bcl_gex = [
        [],
